...
def test_bin_num_expr():
    ...
    expected_code = """
fn score(input: Vec<f64>) -> f64 {
    return ((input[0]) / (-2.0_f64)) * (2.0_f64);
}
"""
...
def test_bin_vector_expr():
    ...
    expected_code = """
fn score(input: Vec<f64>) -> Vec<f64> {
    return add_vectors(vec![1.0_f64, 2.0_f64], vec![3.0_f64, 4.0_f64]);
}
...
def test_bin_vector_num_expr():
    ...
    expected_code = """
fn score(input: Vec<f64>) -> Vec<f64> {
    return mul_vector_number(vec![1.0_f64, 2.0_f64], 1.0_f64);
}
fn add_vectors(v1: Vec<f64>, v2: Vec<f64>) -> Vec<f64> {
    return v1.iter().zip(v2.iter()).map(|(&x, &y)| x + y).collect::<Vec<f64>>();
}
...
def test_pow_expr():
    ...
    expected_code = """
fn score(input: Vec<f64>) -> f64 {
    return f64::powf(2.0_f64, 3.0_f64);
}
"""
...
def test_softmax_expr():
    ...
    expected_code = """
fn score(input: Vec<f64>) -> Vec<f64> {
    return softmax(vec![2.0_f64, 3.0_f64]);
}

...
| **Boosting** | XGBClassifier(gbtree booster only), LGBMClassifier(gbdt/dart/goss booster only) | XGBRegressor(gbtree booster only), LGBMRegressor(gbdt/dart/goss booster only) |
